...
public class clsMusic
{
    ...
    public clsMusic(int intID, string strName, string strSubheading, string strSinger, string strClass,
        enmMusicSource emsSource, string strOtherInfo, bool bolCanDownload = true)
    {
        mscID = intID;
        mscName = strName;
